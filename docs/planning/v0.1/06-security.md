...
**Two separate checks, restated here, detailed at §9 and §11 below.** A verified
...
separate authorization decision (§9, C5 §11's "message-delivery authorization and
